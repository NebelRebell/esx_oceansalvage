...
Config.Zones = {
	...
	Cloakroom = {
		Pos     	= {x = -1592.34, y = 5203.44, z = 3.31},
	...
	VehicleSpawner 	= {
		Pos   		= {x = -1592.53, y = 5212.19, z = 3.01},
	...
	VehicleDeleter = {
		...
		Size  		= {x = 5.0, y = 5.0, z = 1.3},
		Color 		= {r = 255, g = 50, b = 159},
		Type  		= 1,
	...
	Sell = {
		Pos   				= {x = -1600.61, y = 5204.32, z = 3.31},
		Size  				= {x = 3.0, y = 3.0, z = 1.0},
		Color 				= {r = 11, g = 203, b = 159},
		Type  				= 1,
		...
		ItemTime 			= 500,
		ItemDb_name 		= "safestuff",
		--ItemMax 			= 25,
		ItemAdd 			= 5,
		ItemRemove 			= 1,
		ItemRequires 		= "safestuff",
		--ItemDrop 			= 100,
		--ItemPrice  			= 800
	}
...
Config.Oceansalvage = {
	...
	{ [ 'x' ] = 	 -1781.84	, [ 'y' ] = 	5295.14	, [ 'z' ] = 	-0.23	}, --- Testmarker kann gelöscht werden
...
for i=1, #Config.Oceansalvage, 1 do

	Config.Zones['Oceansalvage' .. i] = {
		Pos   = Config.Oceansalvage[i],
		Size  = {x = 1.5, y = 1.5, z = 1.0},
